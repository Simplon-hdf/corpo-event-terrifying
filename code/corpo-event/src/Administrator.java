...
public class Administrator extends User {
    ...
    Administrator(String administratorId, int adminLevel, List<String> permissions, String firstName, String lastName, String mail, String password, String employeeNumber) {
